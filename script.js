        ...
        function animate() {
            ...
            for (let i = 0; i < PARTICLE_COUNT; i++) {
                ...
                if (isFist) {
                    ...
                    colAttr.array[i3] = 1.0; colAttr.array[i3+1] = 0.3;
                } else {
                    ...
                    colAttr.array[i3] = 0.2; colAttr.array[i3+1] = 0.6;
                }
            }
